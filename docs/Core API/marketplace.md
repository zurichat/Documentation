...
## **Errors**
When an error occurs, you will receive an error object. Most of these error objects contain an error code and an error description that helps your applications efficiently identify the problem.
